...
<body>
    ...
    <!-- TITLE SLIDE -->
    <section class="slide title-slide visible" aria-label="Title">
    ...
    <!-- CLOSING SLIDE -->
    <section class="slide closing-slide visible" aria-label="Closing">
        <div class="slide-content">
...
```html
<section class="slide section-divider visible">
